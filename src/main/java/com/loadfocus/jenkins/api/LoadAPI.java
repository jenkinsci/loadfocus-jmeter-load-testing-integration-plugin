...
public class LoadAPI {
    ...
    public JSONArray getTests() {
        logger.println("get api/v1/jmetertests");
        return getListData("api/v1/jmetertests");
    }
    ...
    public JSONObject getState(String testrunname, String testrunid) {
        ...
        String result = doGetRequest("api/v1/jmetertests/state?testrunname=" + testrunname + "&testrunid=" + testrunid);
        logger.println("Result " + result + "\n" + (result.length() > 100 ? result.substring(0, 100) : result));
        if (result.equalsIgnoreCase("NOTRUNNING")) {
            return null;
        }
    ...
    public JSONObject retrieveConfig(String testrunname) {
        ...
        String result = doGetRequest("api/v1/jmetertests/retrieveconfig?testrunname=" + testrunname);
        logger.println("Result " + result + "\n" + (result.length() > 100 ? result.substring(0, 100) : result));
        if (result.equalsIgnoreCase("NOTRUNNING")) {
            return null;
        }
    ...
    public List<Map<String, String>> getTestConfig(String testrunname, String testrunid) {
        ...
        String result = doGetRequest("api/v1/jmetertests/result/config?testrunname=" + testrunname + "&testrunid=" + testrunid);
        logger.println("Result " + result + "\n" + (result.length() > 100 ? result.substring(0, 100) : result));
        if (result.equalsIgnoreCase("NOTRUNNING")) {
            return null;
        }
    ...
    public JSONObject runTest(String testId) {
        ...
        String path = "api/v1/jmetertests/newtest/execute?testrunname=" + testId;
    ...
    public JSONArray getLabels(String testrunname, String testrunid, String apikey) throws UnsupportedEncodingException {
        ...
        String path = "api/v1/jmetertests/labels-noform?apikey=" + apikey;
